...
<body>
<%
Media mda=((Media)request.getAttribute("mda"));
%>
<h1>Edit File Details</h1><div id="fileloader"><button name="Upload">Edit</button></div>

<div id="dialog" title="Edit Path" width="100%" align="center">
<form action="EditMedia" method="post">
<input type="text" name="path" id="file" value=<%=mda.getPath() %>><br>
<input type="hidden" name="id" value="<%=mda.getId()%>">
